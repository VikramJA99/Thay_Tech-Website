  ...
  return (
    <div className="container mx-auto  p-10 py-20">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div>
          <div className="bg-gray-100 p-6 rounded-lg shadow-lg mb-6 animate__animated animate__fadeIn animate__delay-200ms">
          ...
          <div className="bg-gray-100 p-6 rounded-lg shadow-lg animate__animated animate__fadeIn animate__delay-200ms">
